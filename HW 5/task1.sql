...
-- 2
-- List the names of all customers whose last name is Smith. List each customer only once in reverse lexicographical order.
...
-- 6
-- List the dates the restaurant took money in 2015. List each date only once in sorted order.
